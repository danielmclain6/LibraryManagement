			...
			<div class="row justify-content-between align-items-center">
				...
				<div class="collapse navbar-collapse">
					...
					<c:if test="${context == '/LibraryManager/patron.jsp'}">
						<div class="col-md-4 mx-auto">
							<span class="navbar-text page-title" style="font-size: 175%">Patron Account</span>
						</div>
					</c:if>
					...
					<c:if test="${context == '/LibraryManager/patrons.jsp'}">
						<div class="col-md-4 mx-auto">
							<span class="navbar-text page-title">Patrons</span>
						</div>
					</c:if>
					...
					<ul class="navbar-nav aligin-items-center">
						...
						<c:if test="${user == null}">
							...
							<li class="nav-item nav-link welcome-sm"><span
								class="navbar-text">Welcome!</span></li>
						</c:if>
						...
						<c:if test="${user != null}">
							<li class="nav-item nav-link ml-auto"><a
									...
									Out</a></li>
							<span class="navbar-text welcome-sm">Welcome, <c:out
